classdef emData
   ...
   properties
      ...
      rv=struct( 'pos',[], 'unfilt',[], 'vel',[], ...
         ...
         'blink',   struct('paramtype',[],'blinklist',struct()),...
         'fixation',struct('paramtype',[],'fixlist', struct()) );
      lv=struct( 'pos',[], 'unfilt',[], 'unbias',[], ...
         'channel','lv', 'chan_comment',[], ...
         'saccades',struct('paramtype',[],'sacclist',struct()),...
         'blink',   struct('paramtype',[],'blinklist',struct()),...
         'fixation',struct('paramtype',[],'fixlist', struct()) );
      rt=struct( 'pos',[], 'unfilt',[], 'unbias',[], ...
         'channel','rt', 'chan_comment',[], ...
         'saccades',struct('paramtype',[],'sacclist',struct()),...
         'blink',   struct('paramtype',[],'blinklist',struct()),...
         'fixation',struct('paramtype',[],'fixlist', struct()) );
      lt=struct( 'pos',[], 'unfilt',[], 'unbias',[], ...
         'channel','lt', 'chan_comment',[], ...
         'saccades',struct('paramtype',[],'sacclist',struct()),...
         'blink',   struct('paramtype',[],'blinklist',struct()),...
         'fixation',struct('paramtype',[],'fixlist', struct()) );
      hh=struct('pos',[], 'unbias',[], 'channel','hh','chan_comment',[]);
      hv=struct('pos',[], 'unbias',[], 'channel','hv','chan_comment',[]);
      st=struct('pos',[], 'unbias',[], 'channel','st','chan_comment',[]);
      sv=struct('pos',[], 'unbias',[], 'channel','sv','chan_comment',[]);
