...
h.availDataH = uicontrol('Style','popup','Units','pixels',...
   'Position',[x_orig+40 y_pos+4 140 20],'FontSize', fontsize,...
...
h.datachanH = uicontrol('Style','popup','Units','pixels',...
   'Position',[x_orig+180 y_pos+4 60 20],'FontSize', fontsize,...
   'String',[{'rh'};{'lh'};{'rv'};{'lv'}], ...
...
uicontrol('Style', 'text', 'Units', 'pixels',...
   ...
   'HorizontalAlignment','Right','FontSize', fontsize,...
   'String', 'Plot: ');
h.showplotH = uicontrol('Style','Push','Units','Pixels',...
   'Position', [x_orig+43 y_pos+1 40 25],'FontSize', fontsize,...
   'Tooltip','',...
   'UserData',[],'String','Show', 'Callback','nafxAct(''showplot'')');
h.newplotH = uicontrol('Style','Push','Units','Pixels',...
   'Position', [x_orig+85 y_pos+1 40 25],'FontSize', fontsize,...
   'Tooltip','',...
   'UserData',[],'String','New', 'Callback','nafxAct(''newplot'')');
h.updateplotH = uicontrol('Style','Push','Units','Pixels',...
   'Position', [x_orig+125 y_pos+1 50 25],'FontSize', fontsize,...
   'Tooltip','',...
   'UserData',[],'String','Update', 'Callback','nafxAct(''updateplot'')');
h.nafxprepH = uicontrol('Style','Push','Units','Pixels',...
   'Position', [x_orig+175 y_pos+1 60 25],'FontSize', fontsize,...
...
uicontrol('Style', 'text', 'Units', 'pixels',...
   'Position',[100 y_pos 55 23],...
   'HorizontalAlignment','Center', 'FontSize', fontsize,...
   'String', '# found:' );

h.numFovNAFXH = uicontrol('Style','edit','Units','Pixels',...
   'BackgroundColor','cyan','ForeGroundColor','black',...
   'Position', [160 y_pos 65 25],...
...
h.tauVersH = uicontrol('Style','checkbox','Units','Pixels',...
   'Foregroundcolor','k',...
   'Position', [100 y_pos+5 83 20],'String','Use Tau v2', ...
